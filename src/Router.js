...
import zzCssPractice from './components/zzCssPractice';
import hireAMentor from './components/hireAMentor';
  ...
  render() {
    return (
      <Switch>
        ...
        <Route exact path="/CssPractice" component={zzCssPractice} />
        <Route exact path="/hireMentor" component={hireAMentor} />
